...
describe('ProjectService', () => {
  ...
  describe('getProjectById', () => {
    it('should make the correct API call', async () => {
      ...
      Vue.http.get.withArgs(`${Vue.config.apiServer}/api/2.0/projects/project/${projectIdMock}`).resolves('expectedResponse');
  ...
  describe('getProjectStatisticsById', () => {
    it('should make the correct API call', async () => {
      ...
      const projectIdMock = '1234-5678';
      sandbox.stub(Vue.http, 'get');
      Vue.http.get.withArgs(`${Vue.config.apiServer}/api/2.0/projects/project-statistics/${projectIdMock}`).resolves('expectedResponse');
  ...
  describe('getProjectData', () => {
    it('should make the correct API call', async () => {
      ...
      const limitMock = 5;
      sandbox.stub(Vue.http, 'get');
      Vue.http.get.withArgs(`${Vue.config.apiServer}/api/2.0/projects/project-data?deleted=${deletedMock}&sortedBy=${sortedByMock}&sortOrder=${sortOrderMock}&limit=${limitMock}`).resolves('expectedResponse');
  ...
  describe('getProjectsForDojo', () => {
    it('should make the correct API call', async () => {
      ...
      const deletedMock = false;
      Vue.http.get.withArgs(`${Vue.config.apiServer}/api/2.0/projects/projects-for-dojo/${dojoIdMock}?deleted=${deletedMock}`).resolves('expectedResponse');
  ...
  describe('createProject', () => {
    it('should make the correct API call', async () => {
      ...
      Vue.http.post.withArgs(`${Vue.config.apiServer}/api/2.0/projects/create-project`, fileDataMock).resolves('expectedResponse');
  ...
  describe('updateProject', () => {
    it('should make the correct API call', async () => {
      ...
      Vue.http.post.withArgs(`${Vue.config.apiServer}/api/2.0/projects/update-project`, projectDataMock).resolves('expectedResponse');
  ...
  describe('incrementProjectPlays', () => {
    it('should make the correct API call', async () => {
      ...
      sandbox.stub(Vue.http, 'post');
      const projectIdMock = '1234-5678';
      Vue.http.post.withArgs(`${Vue.config.apiServer}/api/2.0/projects/increment-project-plays`, {projectId: projectIdMock}).resolves('expectedResponse');
  ...
  describe('deleteProjectById', () => {
    it('should make the correct API call', async () => {
      ...
      sandbox.stub(Vue.http, 'post');
      const projectIdMock = '1234-5678';
      Vue.http.post.withArgs(`${Vue.config.apiServer}/api/2.0/projects/delete-project`, {projectId: projectIdMock}).resolves('expectedResponse');
